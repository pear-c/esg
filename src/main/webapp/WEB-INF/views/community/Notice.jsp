										...
										<dd>
											<div class="attached_file_wrapper">
												<select id="bannerImage" name=""
													class="select checkFormat selectIsNull" style="width: 205px">
													<option value="Notice_banner01">공지1</option>
													<option value="Notice_banner02">공지2</option>
													<option value="Notice_banner03">공지3</option>
												</select>
...
<script type="text/javascript"src="${pageContext.request.contextPath }/resources/js/community/Notice.js"></script>
</html>