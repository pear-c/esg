					...
					<fieldset>
						...
						<div class="boardWrite">
							...
							<div class="half_box_wrapper">
								...
								<div class="half_box left_line toRcpt">
									<dl>
										...
										<dd>
											<div class="inptDt">
												<label for="toRcptYmd" class="blind" >종료일</label>
												<input class="che_ch" type="checkbox" name="checkbox"
													id="ch_04" checked="checked"> <label for="ch_04" style="top : 5px;"></label>
												 <input	type="text" name="toRcptYmd" id="toRcptYmd"
													autocomplete="off" style="width: 130px;"> <img
													src="../../resources/img/icon_calendar.gif" style="left: 33px;" alt="날짜선택" title="날짜선택">
											</div>
										</dd>
									</dl>
								</div>
							...
							<div class="half_box_wrapper imageSetting" style="display: none">
								<div class="right_line imageClass half_box">
									<dl>
										<dt>
											<label>이미지</label>
										</dt>
										...
										<dd>
											<div class="attached_file_wrapper">
												<input type="file" name="files" class="clearFormat"
													...
													readonly="readonly">
													<input type="button" id="imageDetail" style="position: absolute;top: 5px;right: 152px;background: #b7b7b7;background-image: url(../resources/img/ic_search.png);background-repeat: no-repeat;background-position: 3px 2px;width: 22px;height: 22px;border-radius: 11px;border-color: #b7b7b7;"/>
								...
								<div class="half_box left_line bannerPath">
									<dl>
										<dt>
											<label>배너이미지<strong class="required">*</strong></label>
										</dt>
										<dd>
											<div class="attached_file_wrapper">
												<select id="bannerImage" name=""
													class="select checkFormat selectIsNull" style="width: 205px">
													<option value="promotion_banner01">홍보1</option>
													<option value="promotion_banner02">홍보2</option>
													<option value="promotion_banner03">홍보3</option>
												</select>
												<input type="button" id="imageDetail2" style="position: absolute;top: 5px;right: 270px;background: #b7b7b7;background-image: url(../resources/img/ic_search.png);background-repeat: no-repeat;background-position: 3px 2px;width: 22px;height: 22px;border-radius: 11px;border-color: #b7b7b7;"/>
											</div>
										</dd>
									</dl>
								</div>
...
<script type="text/javascript"src="${pageContext.request.contextPath }/resources/js/community/Promotion.js"></script>
</html>