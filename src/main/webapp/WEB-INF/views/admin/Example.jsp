		...
		<div id="contents">
			...
			<section id="search">
				<form class="searchSet">
					<div class="row">
						<div class="item">
							<span class="labl">회사명</span> <input class="inpt" type="text" id="coNm"
									...
									<tbody>
										<tr>
											...
											<td>
											    ...
											    <input type="text" id="popUserId" name="" value="" /> 
											</td>
											<td>
											    <input type="hidden" id="hiddenCoId" name="" value="" /> 
											    <input type="text" id="popCoId" name="" value="" /> 
											</td>
										</tr>
									</tbody>
								</table>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/admin/Example.js"></script>
</html>