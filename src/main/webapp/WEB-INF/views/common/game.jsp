...
<script type="text/javascript">
	var Yl = {
		...
		init : function() {
			...
			for (var i = 0; i < this.nNum; i++) {
				...
				this.arrTopDiv[i].innerHTML = (i + 1)
						...
						+ '" />';
				this.arrBotDiv[i].innerHTML = '<input type="text" id="inp_bot_'
						+ i + '" value="" style="width:90%" tabindex="'
						+ ((i + 1) + 50) + '" />';
		...
		moveStart : function(sXy, pno, nSx, nSy) {
			...
			this.arrMovDiv[nLen] = this
					.getDiv("2px", "2px", this.arrColor[pno]);
...
<body>
	<div id="div_step1" style="font-size: 16px;">
	...
	<div id="div_body"
		style="width: 1000px; height: 450px; border: 1px solid #CCCCCC; position: relative;background: #fdefef;"></div>
